...
- **Shape a PARA deliverable** — turn accumulated wiki knowledge into a human-facing project brief or area dashboard, shaped for a specific reader (standing reference material lives in the browsable wiki itself now). Run `vlt-extract`. This is your primary work and your sanctioned write into PARA. The hard gate (≥2 contributing wiki pages) is a feature: a thin topic is a cue to send the user to the Librarian or Researcher first, not to thin out an artifact.
