...
// depends_on: ["frontmatter@14", "wiki-supersession@2", "wiki-index@2", "write-verification@6"]
...
const PAGE_SCAN = {
  ...
  properties: {
    ...
    sources_vs_prose: { type: 'string', enum: ['match', 'diverge_prose_gap', 'diverge_frontmatter_gap', 'diverge_unclassified', 'no_prose_section'], description: 'GAP B verdict — apply the prompt Gap B rule, per write-verification@6' },
    ...
    unmarked_supersession: { type: 'array', items: { type: 'string' }, description: 'silently-updated/conflicting claims lacking a [!superseded]/[!stale] callout, or consensus claims lacking citations. A missing or stale attestation is NEVER an unmarked supersession (per write-verification@6 Scope rule).' },
...
// Attestation is a self-marker under write-verification@6's Scope rule: its absence is never a
